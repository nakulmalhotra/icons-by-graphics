...
imagefill($img,150,200,$green);
imagefill($img,170,140,$green);
imagefill($img,90,200,$green);
imagefill($img,208,200,$green);


imagefill($img,90,178,$green);
imagefill($img,208,178,$green);
imagefill($img,92,212,$green);
imagefill($img,210,210,$green);

imagefill($img,126,250,$green);
imagefill($img,174,250,$green);
imagefill($img,171,265,$green);
imagefill($img,129,265,$green);

imagefill($img,107.5,73,$green);
imagefill($img,198.5,74,$green);

imagefill($img,116,87,$green);
imagefill($img,188,90,$green);
